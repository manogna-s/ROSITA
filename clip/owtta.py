...
from code.ROSITA.clip import clip
from code.ROSITA.models.maple import CustomCLIP_MaPLe
from code.ROSITA.models.clip import CustomCLIP_CLIP

from code.ROSITA.utils.data_utils import prepare_ood_test_data, AugMixAugmenter
from code.ROSITA.utils.clip_tta_utils import get_classifiers

from code.ROSITA.utils.registry import get_method
...
if __name__ == "__main__":
    ...
    if args.weak_OOD in ['ImagenetCOOD', 'ImagenetROOD', 'VisdaOOD']:
        assert args.strong_OOD in ['MNIST', 'SVHN'], f"Only MNIST and SVHN are supported strong OOD datasets with {args.weak_OOD} to avoid overlap of classes"
    ...
    result_metrics = method(args, model, test_loader, weak_ood_classifiers)
