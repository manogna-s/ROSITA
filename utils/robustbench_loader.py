...
def make_custom_dataset(root, path_imgs, cls_dict, tesize):
...
class CustomDatasetFolder(VisionDataset):
    ...
    def __init__(self, root, loader, extensions=None, transform=None, target_transform=None, is_valid_file=None, tesize=10000):
...
class CustomImageFolder(CustomDatasetFolder):
    ...
    def __init__(self, root, transform=None, target_transform=None,
                 loader=default_loader, is_valid_file=None, tesize=10000):
